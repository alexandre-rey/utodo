...
function CGU() {
  ...
  // SEO setup for CGU page
  useSEO({
    title: t('legal.cgu.title') + ' - µTodo',
    description: 'Consultez les conditions générales d\'utilisation de µTodo, votre gestionnaire de tâches simple et sécurisé.',
    type: 'article'
  });
